...
author: Darren James
date: 2025-08-06
description: Learn how to make your `ggplot` graphs prettier.
execute:
  eval: true
  echo: true
---
...
First lets load some packages. The `ratdat` package will be our example data for this lesson. It has rodent data from the Portal project in Arizona.
