...
author: 
  ...
  - Darren James
date: 2022-06-19
description: Statistical inference and hypothesis testing in R
execute:
  eval: true
  echo: true
---
...
file_url <- "https://pasta.lternet.edu/package/data/eml/knb-lter-jrn/210011003/105/127124b0f04a1c71f34148e3d40a5c72"
# Once you have an API key, assign it to a variable too.  Below, 
# we're getting it from an environmental variable,  but you can 
# replace the "Sys.getenv" part with your actual key.
my_key <- Sys.getenv("EDI_API_KEY")
# Put it all together
input_file <- paste0(file_url, "?key=", my_key)

# Now load it
anpp <- read_csv(input_file)

# Now look at the strucdture of the data
str(anpp)
```
